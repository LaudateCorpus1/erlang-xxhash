...
-export([hash32/1, hash32/2, hash32_init/0, hash32_init/1, hash32_update/2,
         hash32_digest/1, hash64/1, hash64/2, hash64_init/0, hash64_init/1, hash64_update/2,
         hash64_digest/1]).
...
init() ->
    ...
    erlang:load_nif(
        filename:join(PrivDir, xxhash), 0).
